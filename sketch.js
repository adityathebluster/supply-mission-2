...
function setup() {
	...
	container1=createSprite(320,600,20,100)
	container1.shapeColor=color("red");
	container2=createSprite(450,600,20,100)
	container2.shapeColor=color("red");
	container3=createSprite(385,650,150,20)
	...
	container3 = Bodies.rectangle(width/2,630,150,20,{isStatic:true});
